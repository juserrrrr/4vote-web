...
function SideMenu({ isOpen, toggleSidebar }: SideMenuProps) {
  return (
    <aside
      className={`h-[calc(100vh-70px)] fixed left-0 top-[70px] py-7 px-[6px] sm:px-[14px] flex flex-col bg-white text-corPrincipal z-20 ${isOpen ? 'w-64' : 'w-16 sm:w-20'} transition-all drop-shadow-xl`}
    >
